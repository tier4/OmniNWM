...
class DataArguments:
    ...
    # TMI (Tri-Modal Interpreter) related parameters
    use_tmi_features: bool = field(
        default=False,
        metadata={"help": "Whether to use pre-extracted TMI fusion features instead of raw images."},
    )
    tmi_feature_dir: Optional[str] = field(
        default=None,
        metadata={"help": "Directory containing TMI features for training data."},
    )
    eval_tmi_feature_dir: Optional[str] = field(
        default=None,
        metadata={"help": "Directory containing TMI features for evaluation data."},
    )
    tmi_hidden_size: int = field(
        default=3584,
        metadata={"help": "Hidden dimension of TMI features (should match model hidden size)."},
    )
    custom_collator_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to custom data collator module for TMI features."},
    )
