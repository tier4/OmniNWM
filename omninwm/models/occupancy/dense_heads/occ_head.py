...
from omninwm.models.occupancy.dense_heads.lovasz_softmax import lovasz_softmax
from omninwm.models.occupancy.utils import coarse_to_fine_coordinates, project_points_on_img
from omninwm.models.occupancy.utils.nusc_param import nusc_class_frequencies, nusc_class_names
from omninwm.models.occupancy.utils.semkitti import geo_scal_loss, sem_scal_loss, CE_ssc_loss
                ...
                for b in range(B):
                    ...
                    if img_feats is not None and self.sample_from_img:
                        ...
                        img_uv, img_mask = project_points_on_img(new_coord, rots=transform[0][b:b+1], trans=transform[1][b:b+1],
                                    ...
                                    W_img=transform[6][1], H_img=transform[6][0],
                    ...
                    # print( B, append_feats[0].shape, self.fine_mlp, output['fine_output'][0].shape  )
