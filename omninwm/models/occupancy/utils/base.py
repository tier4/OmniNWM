...
from omninwm.models.occupancy.utils.parrots_wrapper import SyncBatchNorm, _BatchNorm, _InstanceNorm
try:
...
CONV_LAYERS['DCN'] = DeformConv2dPack
...
NORM_LAYERS['SyncBN'] = SyncBatchNorm
...
UPSAMPLE_LAYERS = dict()
UPSAMPLE_LAYERS['nearest']=nn.Upsample
UPSAMPLE_LAYERS['bilinear']=nn.Upsample
...
UPSAMPLE_LAYERS['deconv']=ConvTranspose2d
...
activation_LAYERS['LeakyReLU'] = nn.LeakyReLU
activation_LAYERS['PReLU'] = nn.PReLU
activation_LAYERS['RReLU'] = nn.RReLU
activation_LAYERS['ReLU6'] = nn.ReLU6
activation_LAYERS['ELU'] = nn.ELU
activation_LAYERS['Sigmoid'] = nn.Sigmoid
activation_LAYERS['Tanh'] = nn.Tanh
activation_LAYERS['SiLU'] = nn.SiLU
activation_LAYERS['GELU'] = nn.GELU
...
def build_activation_layer(cfg: Dict) -> nn.Module:
    ...
    if layer_type not in activation_LAYERS:
        ...
        activation = activation_LAYERS.get(layer_type)
