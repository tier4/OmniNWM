...
from omninwm.datasets.aspect import get_closest_ratio, get_resolution_with_aspect_ratio
...
if __name__ == "__main__":
    ...
    # for 
    bucket_id = bucket.get_bucket_id(37, 448, 800, 12)
    embed()
    exit()
    bucket.get_batch_size(bucket_id)
    bucket.get_thw(bucket_id)